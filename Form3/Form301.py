...
frmplncn= Frame(bg = "white", width = 1000, height = 400)

frmcnstrccn = Frame(bg = "white", width = 1000, height = 400)

frmoprcn = Frame(bg = 'white', width = 1000, height = 400)

frmabndn = Frame(bg = 'white', width = 1000, height = 400)

frmoprncyabdn = Frame(bg = 'white', width = 1000, height = 400)

frmtodos = Frame(bg = 'white', width = 1000, height = 400)
